...
# В классе PositiveList переопределите метод append(self, x) таким образом, чтобы
# при попытке добавить неположительное целое число бросалось исключение
...
plst = PositiveList([1,2,3,4])
plst.append(4)
print( type(plst), plst)
plst.append(-1)
print( type(plst), plst)
